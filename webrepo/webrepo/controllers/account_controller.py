...
from webrepo.viewmodels.forgotpassword_viewmodel import ForgotPasswordViewModel
from webrepo.viewmodels.register_viewmodel import RegisterViewModel
from webrepo.viewmodels.resetpassword_viewmodel import ResetPasswordViewModel
